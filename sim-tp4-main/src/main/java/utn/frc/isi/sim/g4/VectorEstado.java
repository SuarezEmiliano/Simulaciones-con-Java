...
//                clientesQueEstabanLeyendoYAhoraEstanEnCola.remove(indiceMenorHoraLlegadaEnCola);
    ...
    private static double calcularRandomParaConsultas(String tipoLlegada){
...
//                            System.out.println("que hay en el vector: " + columnasHorasLlegadaArray[i] + " " + vectorAnterior[columnasHorasLlegadaArray[i]]);
    ...
    private static double calcularRNDUniformeTiempoConsulta(double rnd , String tipoLlegada, String estadoanterior1, String estadoanterior2) {
        if ((tipoLlegada.equals(EnumTiposLlegada.Consulta1.getNombre()) || tipoLlegada.equals(EnumTiposLlegada.Consulta2.getNombre()))) {
            return App.minDemoraConsulta + rnd * (App.maxDemoraConsulta - App.minDemoraConsulta);
        }
        return 0;
    }

    private static double calcularFinConsulta1(double reloj, double rndConsulta , String tipoLlegada, String estadoanterior1, String estadoanterior2, double FinConsulta1Anterior, String evento, double personasEnCola) {
        ...
        if (tipoLlegada.equals(EnumTiposLlegada.Consulta1.getNombre())) {
            return reloj + rndConsulta;
        }
        return FinConsulta1Anterior;

    }

    private static double calcularFinConsulta2(double reloj, double rndConsulta , String tipoLlegada, String estadoanterior1, String estadoanterior2, double FinConsulta2Anterior, String evento, double personasEnCola) {
...
//        System.out.println("El valor mínimo es " + minValue + " en la columna " + minColumn + " y el modo es " + mode);
    ...
    public static Object[][] generadorVectoresParImpar() {
        ...
        while (reloj < App.tiempoSimulacion && fila < App.CANTIDAD_MAXIMA_ITERACIONES) {
            ...
            if (fila == 0) {
                ...
                rnd4 = calcularRandomParaConsultas(tipoLlegada);
                rnd4UniformeTiempo = calcularRNDUniformeTiempoConsulta(rnd4, tipoLlegada, (String) vectorAnterior[6], (String) vectorAnterior[7]);
                finConsultaServidor1 = calcularFinConsulta1(reloj, rnd4UniformeTiempo, tipoLlegada, (String) vectorAnterior[6], (String) vectorAnterior[7], (double) vectorAnterior[16], evento, (double) vectorAnterior[26]);
                finConsultaServidor2 = calcularFinConsulta2(reloj, rnd4UniformeTiempo, tipoLlegada, (String) vectorAnterior[6], (String) vectorAnterior[7], (double) vectorAnterior[17], evento, (double) vectorAnterior[26]);
...
//            System.out.println(fila);
    ...
    public static void main(String[] args) {
        Object[][] matriz = generadorVectoresParImpar();
